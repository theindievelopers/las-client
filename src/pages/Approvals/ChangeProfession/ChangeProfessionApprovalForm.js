...
const ChangeProfessionApprovalForm = React.memo(({
  showForm, handleShowForm, handleRefresh,selectedApplication,
  selectedApplicationData, isReady, selectedApproval, empCode,
  projectManager, immediateSupervisor, hraManager, coo, ceo, accessLevel, 
  handleReview, handleDeny, handleApproved, handleEditSupervisorNotes,
  handleShowSupervisorNotes, handleSaveSupervisorNotes, hideSupervisorNotes,
  handleSupervisorNotesChange, supervisorNotes, isEdit, handleEditProjectManagerNotes,
  handleShowProjectManagerNotes, hideProjectManagerNotes, handleProjectManagerNotesChange,
  handleSaveProjectManagerNotes, projectManagerNotes, handleEditChangeInSalary,
  handleShowChangeInSalary, hideChangeInSalary, handleSaveChangeInSalary, handleNewBasicChange,
  handleNewTransportationChange, handleNewGeneralAllowanceChange, handleNewTelephoneAllowanceChange,
  handleNewHousingAllowance, handleNewFoodAllowanceChange, handleNewSalaryEffectivedateChange, handleHRNotesChange,
  handleEditCEONotes, handleShowCEONotes, handleCEONotesChange, hideCEONotes, handleSaveCEONotes,handleEditCOONotes,
  handleShowCOONotes, hideCOONotes, handleCOONotesChange, handleSaveCOONotes,
  ...props
}) => {
            ...
            <Col md={12}>
                  ...
                  <Dropdown isOpen={dropdownOpen} toggle={toggleAction}>
                    ...
                    <DropdownMenu>
                      ...
                      {selectedApplicationData.new_basic || selectedApplicationData.new_food_allowance || selectedApplicationData.new_general_allowance || selectedApplicationData.new_housing_allowance || 
                        ...
                        <DropdownItem onClick={handleEditChangeInSalary}>EDIT CHANGE IN SALARY</DropdownItem>
                        :
                        <DropdownItem onClick={handleShowChangeInSalary}>ADD CHANGE IN SALARY</DropdownItem>
                      }
              ...
              {accessLevel === 1 || empCode === selectedApplicationData.immediate_supervisor ?
                <div style={{ paddingBottom: 10, paddingTop: 10 }} hidden={hideSupervisorNotes}>
                  <FormGroup>
                    <Label>
                      Supervisor Justification: <span style={{ color: "red" }}>*</span>
                    </Label>
                    <Input
                      bsSize="sm"
                      type="textarea"
                ...
                <React.Fragment>
                  <div className="float-right mb-3 ml-2">
                    {selectedApplicationData.new_basic || selectedApplicationData.new_food_allowance || selectedApplicationData.new_general_allowance || selectedApplicationData.new_housing_allowance || 
                      ...
                      :
                      <Button color="secondary" onClick={handleShowChangeInSalary}
                        disabled={selectedApplication.status === "APPROVED" || selectedApplication.status === "DENIED" || selectedApproval.status === "DENIED" || selectedApproval.status === "APPROVED"}
                      >CHANGE IN SALARY</Button>
                    }
                  </div>
                </React.Fragment>
                : ""
              ...
              {accessLevel === 1 || empCode === hraManager.code ?
                <div style={{ paddingBottom: 10, paddingTop: 52 }} hidden={hideChangeInSalary}>
                  <Label>
                    CHANGE IN SALARY:
                  </Label>
                  <Row>
                  ...
                  <div style={{ marginTop: 4 }}>
                    <Button color="primary" onClick={handleSaveChangeInSalary} style={{ marginRight: "4px" }}>SUBMIT</Button>
                    <Button color="secondary" onClick={handleShowChangeInSalary}>CANCEL</Button>
                  </div>
                </div>
...
export default ChangeProfessionApprovalForm;